  ...
  int get hashCode => $mrjf($mrjc(
      ...
      $mrjc(
          ...
          $mrjc(
              ...
              $mrjc(
                  revealed.hashCode,
                  $mrjc(orginalySecret.hashCode,
                      $mrjc(presentlySecret.hashCode, notify.hashCode)))))));
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class DateUser extends DataClass implements Insertable<DateUser> {
  ...
  @override
  int get hashCode => $mrjf($mrjc(partnerId.hashCode,
      $mrjc(name.hashCode, $mrjc(profilePhoto.hashCode, notify.hashCode))));
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DateUser &&
...
class $DateUsersTable extends DateUsers
  ...
  @override
  List<GeneratedColumn> get $columns => [partnerId, name, profilePhoto, notify];
  @override
...
class Notification extends DataClass implements Insertable<Notification> {
  ...
  Notification copyWith(
          {String? userName, String? userId, String? type, bool? seen}) =>
      Notification(
  ...
  int get hashCode => $mrjf($mrjc(userName.hashCode,
      $mrjc(userId.hashCode, $mrjc(type.hashCode, seen.hashCode))));
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $NotificationsTable extends Notifications
  ...
  @override
  List<GeneratedColumn> get $columns => [userName, userId, type, seen];
  @override
